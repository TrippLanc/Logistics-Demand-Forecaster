...
def run_ingestion():
    ...
    # Open an explicit connection block to force transaction commits
    with engine.begin() as connection:
        ...
        customers_df.to_sql('customers', con=connection, if_exists='append', index=False)
        ...
        order_items_df.to_sql('order_items', con=connection, if_exists='append', index=False)
        ...
        fulfillment_df.to_sql('fulfillment', con=connection, if_exists='append', index=False)
